...
def get_keypoints(keypoints, mode):
    ...
    # Remove the non annotated keypoints and replace them by the mean of the pre-existing keypoints
...
def to_spherical(xyz):
    ...
    if theta < 0 or theta > math.pi :  # 0 when positive x and no z.:
        print("here", theta, math.pi)
